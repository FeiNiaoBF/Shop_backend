...
type RoleReq struct {
	g.Meta `path:"/role/add" method:"post" summary:"添加角色角色接口" tags:"role"`
...
type RoleDeleteReq struct {
	g.Meta `path:"/role/delete" method:"delete" summary:"删除角色接口" tags:"role"`
	Id     uint `v:"min:1#请选择需要删除的角色" dc:"角色"`
}
type RoleDeleteRes struct{}

type RoleUpdateReq struct {
	g.Meta `path:"/role/update" method:"post" summary:"更新角色接口" tags:"role"`
...
type RoleGetListCommonReq struct {
	g.Meta `path:"/role/list" method:"get" summary:"列表角色接口" tags:"role"`
	CommonPaginationReq
}
